...
class SKHomeActivityTests {

    @get:Rule
    var activityScenarioRule = activityScenarioRule<SKHomeActivity>()
    //val rule = lazyActivityScenarioRule<SKSplashActivity>()

    private val mockHomeViewModel = mock<SKHomeViewModel>()
    private lateinit var scenario: ActivityScenario<SKHomeActivity>
    private lateinit var activity: SKHomeActivity
    ...
    fun testOnCreate() {
        ...
        scenario.onActivity {
            ...
            verifyBlocking(mockHomeViewModel) {
                loadGames()
            }
        }
    }
