...
open class SKAboutActivity : SBActivity(R.layout.activity_about) {

    companion object {
        fun getIntent(context: Context): Intent {
            return Intent(context, SKAboutActivity::class.java)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewAppVersion.text = getString(R.string.app_version_label, BuildConfig.VERSION_NAME, BuildConfig
            .VERSION_CODE)
    }
}
